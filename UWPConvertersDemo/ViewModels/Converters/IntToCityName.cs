...
namespace UWPConvertersDemo.ViewModels.Converters
{
    ...
    {
        private List<string> _names = new List<string> {"Amsterdam", "Bergen", "Budapest", "Copenhagen", "Dubrovnik", "Edinburgh", "London", "New York", "Paris", "Prague", "Rome", "St. Petersburg", "Vienna" };
